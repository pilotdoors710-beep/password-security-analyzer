...
def register():
    ...
    print("Uppercase letter:", "✅" if upper else "❌ Add at least one uppercase letter (A–Z)")
    print("Lowercase letter:", "✅" if lower else "❌ Add at least one lowercase letter (a–z)")
    print("Number:", "✅" if number else "❌ Add at least one number (0–9)")
    print("Symbol:", "✅" if symbol else "❌ Add at least one symbol (!, @, #, etc.)")
